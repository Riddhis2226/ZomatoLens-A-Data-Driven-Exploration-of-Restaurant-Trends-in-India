...
📁 Project Structure
📦 Level 1 - Exploratory Data Analysis │ ├── level1_dashboard.py # Streamlit dashboard script ├── style.css # Custom UI styling (dark neon theme) ├── Data Analysis Internship__Dataset__Cognifyz Technologies.csv ├── level1_summary.csv # (Auto-generated summary file) ├── Task 1 - task 1.py ├── Task 2 - task 2.py ├── Task 3 - task 3.py └── Task 4 - task 4.py

🚀 How to Run the Dashboard
Install Dependencies Open terminal and run:

pip install streamlit pandas plotly numpy
Run the Dashboard Navigate to the project folder and execute:
